...
<head>
    ...
    <title>Admin Login - SEO Master</title>
...
<body class="bg-white dark:bg-[#212121] text-black dark:text-white flex items-center justify-center min-h-screen">
    ...
    <div class="w-full max-w-[400px] px-5">
        ...
        <div class="mt-6 text-center text-sm">
            <p class="text-gray-400 dark:text-gray-500">Don't have an account? <a href="{{ route('admin.register') }}" class="text-[#10a37f] hover:underline dark:text-[#10a37f]">Register</a></p>
        </div>
    </div>
